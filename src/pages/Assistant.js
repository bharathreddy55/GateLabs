      ...
      <div class="h-[calc(100vh-6.5rem)] flex flex-col gap-4 animate-fade-in font-sans">
        ...
        <div class="glass-panel p-4 rounded-3xl flex items-center justify-between border border-slate-200/60 dark:border-white/[0.07]">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3 class="font-display font-extrabold text-sm text-slate-900 dark:text-white">AI Study Assistant</h3>
              <p class="text-xs text-slate-400 dark:text-slate-400 font-medium">Powered by Google Gemini 1.5 Flash</p>
            </div>
          </div>
        ...
        <!-- Chat Container -->
        <div id="chat-messages-container" class="flex-1 glass-panel p-5 rounded-3xl overflow-y-auto flex flex-col gap-3.5 border border-slate-200/60 dark:border-white/[0.07]">
